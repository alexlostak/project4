...
public class A4SampleTest {
	...
	/*
	 * 4. KillCritters Test: killCritters Test for make critter and stats, and
	 * step Creates large number of make critters and compare stats after 500
	 * steps Expects all Critters to be dead
	 */
	 ...
	 * 6. ParseErrors
	 * 
	 * Test: ParseErrors Test for errors within valid inputs Expects errors to
	 * be printed
	 */
	...
	public void showEmptyWorld() {
		...
		/*
		 * Test: InvalidCritter Expects error in creating critters
		 */
		Params.world_width = 20;
		Params.world_width = 20;
		Params.walk_energy_cost = 2;
	...
	String cleanString(String input) {
		input = input.replace("critter>", "").replace("critters>", "").replace("\r\n", "\n").trim();
